...
grep -q 'name="PutBookBoxArea" type="Area3D" parent="ARCHIVE/cardboardBoxOpen"' "$scene"
grep -q 'name="PutBookNearBoxAnchor" type="Marker3D" parent="ARCHIVE"' "$scene"
grep -q 'name="PutBookFarBoxAnchor" type="Marker3D" parent="ARCHIVE"' "$scene"
