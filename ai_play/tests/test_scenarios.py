...
def test_scenario_request_limits_are_hard_caps():
    for scenario_id in supported_scenario_ids():
        assert scenario_act_request_limit(scenario_id, 500) == 150
...
def test_find_key_round_request_limits_are_allowlisted():
    ...
    assert scenario_round_act_request_limit("find_key", 200) == 150
    assert scenario_act_request_limit("find_key", 500, 200) == 150
